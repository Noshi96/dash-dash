    ...
    <Box bgColor={'#010101'} minHeight={screenHeight} p={6}>
      ...
      <Box width={'100%'} position={'relative'} mt={6} p={3} bgColor={`${theme.color}.600`} roundedTop={'lg'}>
        <Box rounded={'lg'} shadow={'6'} style={newStyles.coverImageWrapper}>
          <Image width={'container'} source={require('../../../assets/eventCovers/volleyballcover.png')} style={newStyles.coverImage}
                 alt={'eventimg'}/>
        </Box>
        <HStack space={3} justifyContent="flex-start" px={4} pb={4} position={'absolute'} bottom={0}>
      ...
      <Box p={6} mt={6} bgColor={`${theme.color}.700`} rounded={'lg'}>
        <Heading size="md" color={'white'}>Gdzie i kiedy</Heading>

        <HStack justifyContent="flex-start" mt={3}>
          <VStack alignItems="center" justifyContent={'center'} mr={2}>
            <Icon as={MaterialCommunityIcons} name="calendar-clock" color="white" size={'md'}></Icon>
          </VStack>
        ...
        <HStack justifyContent="flex-start" mt={3}>
          <VStack alignItems="center" justifyContent={'center'} mr={2}>
            <Icon as={MaterialCommunityIcons} name="map-marker-radius-outline" color="white" size={'md'}></Icon>
          </VStack>
      ...
      <Box p={6} mt={6} bgColor={`${theme.color}.800`} rounded={'lg'}>
        <Heading size="md" color={'white'} mb={1}>Zawodnicy</Heading>


        <Text fontSize="lg" color={themeTextColor} mt={3}>Biorący udział</Text>
        <Box justifyContent={'flex-start'} alignItems={'flex-start'} pl={4} mt={3}>
          <Avatar.Group _avatar={{ size: "16" }} max={4} bgColor={'red'}>
        ...
        <Text fontSize="lg" color={themeTextColor} mt={3}>Zaproszeni</Text>
        <Box justifyContent={'flex-start'} alignItems={'flex-start'} pl={4} mt={3}>
          <Avatar.Group _avatar={{ size: "12" }} max={6}>
            <Avatar bg="green.500" source={{
              uri: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
            }}>
              AJ
        ...
        <Text fontSize="lg" color={themeTextColor} mt={3}>Odrzucono</Text>
        <Box justifyContent={'flex-start'} alignItems={'flex-start'} pl={4} mt={3}>
          <Avatar.Group _avatar={{ size: "12" }} max={6}>
            <Avatar bg="green.500" source={{
              uri: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
